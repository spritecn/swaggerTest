...
public class SourceRecord extends UpdatableRecordImpl<SourceRecord> implements Record9<Integer, String, String, Short, Long, Long, Short, String, String> {

    private static final long serialVersionUID = -263466404;
    ...
    /**
     * Setter for <code>source.host</code>.
     */
    public SourceRecord setHost(String value) {
        set(8, value);
        return this;
    }

    /**
     * Getter for <code>source.host</code>.
     */
    ...
    @Override
    public Row9<Integer, String, String, Short, Long, Long, Short, String, String> valuesRow() {
    ...
    @Override
    public SourceRecord values(Integer value1, String value2, String value3, Short value4, Long value5, Long value6, Short value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SourceRecord(Integer id, String url, String name, Short invalid, Long lastUpdateTime, Long lastFetchTime, Short autoFetchInterval, String basePath, String host) {
        super(Source.SOURCE);
