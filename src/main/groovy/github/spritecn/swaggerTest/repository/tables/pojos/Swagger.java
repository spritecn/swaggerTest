...
public class Swagger implements Serializable {
    ...
    public Swagger setId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Swagger setSourceUrl(String sourceUrl) {
        this.sourceUrl = sourceUrl;
        return this;
    }
    ...
    public Swagger setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Swagger setInvalid(Integer invalid) {
        this.invalid = invalid;
        return this;
    }
    ...
    public Swagger setLastUpdateTime(Integer lastUpdateTime) {
        this.lastUpdateTime = lastUpdateTime;
        return this;
    }
    ...
    public Swagger setLastFetchTime(Integer lastFetchTime) {
        this.lastFetchTime = lastFetchTime;
        return this;
    }
    ...
    public Swagger setAutoFetchInterval(Integer autoFetchInterval) {
        this.autoFetchInterval = autoFetchInterval;
        return this;
    }
    ...
    public Swagger setSchemes(String schemes) {
        this.schemes = schemes;
        return this;
    }
